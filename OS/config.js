window.DEFAULT_OS_CONFIG = {
    ...
    "windows": {
        ...
        "window-fun-3-my-room-1": {
            "title": "my_computer\\fun\\my room",
            "width": 800,
            "height": 600,
            "top": "10%",
            "left": "20%",
                ...
                "payload": [
                    {
                        ...
                        "action": {
                            "type": "openImage",
                            "payload": "file_sys/my_computer/fun [3]/my room [1]/Lights Off [1].jpg",
                            "title": "Lights Off [1].jpg"
                        }
                    },
                    {
                        "id": "lights-on2jpg-y1reu",
                        "name": "Lights ON.jpg",
                        "iconType": "imageFile",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#B2EBF2\" d=\"M21.4,6.6l-2.8-2.8C18.3,3.5,17.9,3.3,17.5,3.3H6.5C5.7,3.3,5,4,5,4.8v14.4c0,0.8,0.7,1.5,1.5,1.5h11c0.8,0,1.5-0.7,1.5-1.5V7.5C19,7.1,18.8,6.7,18.6,6.4L21.4,6.6z M13,18H7v-2h6V18z M17,14H7v-2h10V14z M17,10H7V8h10V10z\"/></svg>",
                        "action": {
                            "type": "openImage",
                            "payload": "file_sys/my_computer/fun [3]/my room [1]/Lights ON[2].jpg",
                            "title": "Lights ON[2].jpg"
                        }
                    },
                    {
                        "id": "actual-room-3jpg-f41hf",
                        "name": "actual room.jpg",
                        "iconType": "imageFile",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#B2EBF2\" d=\"M21.4,6.6l-2.8-2.8C18.3,3.5,17.9,3.3,17.5,3.3H6.5C5.7,3.3,5,4,5,4.8v14.4c0,0.8,0.7,1.5,1.5,1.5h11c0.8,0,1.5-0.7,1.5-1.5V7.5C19,7.1,18.8,6.7,18.6,6.4L21.4,6.6z M13,18H7v-2h6V18z M17,14H7v-2h10V14z M17,10H7V8h10V10z\"/></svg>",
                        "action": {
                            "type": "openImage",
                            "payload": "file_sys/my_computer/fun [3]/my room [1]/actual room [3].jpg",
                            "title": "actual room [3].jpg"
                        }
                    },
                    {
                        "id": "in-plasticity-4jpg-7txs6",
                        "name": "in plasticity.jpg",
                        "iconType": "imageFile",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#B2EBF2\" d=\"M21.4,6.6l-2.8-2.8C18.3,3.5,17.9,3.3,17.5,3.3H6.5C5.7,3.3,5,4,5,4.8v14.4c0,0.8,0.7,1.5,1.5,1.5h11c0.8,0,1.5-0.7,1.5-1.5V7.5C19,7.1,18.8,6.7,18.6,6.4L21.4,6.6z M13,18H7v-2h6V18z M17,14H7v-2h10V14z M17,10H7V8h10V10z\"/></svg>",
                        "action": {
                            "type": "openImage",
                            "payload": "file_sys/my_computer/fun [3]/my room [1]/in plasticity [4].jpg",
                            "title": "in plasticity [4].jpg"
                        }
                    },
                    {
                        "id": "modeling-5jpg-jl1lt",
                        "name": "modeling.jpg",
                        "iconType": "imageFile",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#B2EBF2\" d=\"M21.4,6.6l-2.8-2.8C18.3,3.5,17.9,3.3,17.5,3.3H6.5C5.7,3.3,5,4,5,4.8v14.4c0,0.8,0.7,1.5,1.5,1.5h11c0.8,0,1.5-0.7,1.5-1.5V7.5C19,7.1,18.8,6.7,18.6,6.4L21.4,6.6z M13,18H7v-2h6V18z M17,14H7v-2h10V14z M17,10H7V8h10V10z\"/></svg>",
                        "action": {
                            "type": "openImage",
                            "payload": "file_sys/my_computer/fun [3]/my room [1]/modeling [5].jpg",
                            "title": "modeling [5].jpg"
                        }
                    },
                    {
                        "id": "about-thistxt-0wb0m",
                        "name": "about this.txt",
                        "iconType": "notepad",
                        "description": "",
                        "iconSVG": "",
                        "action": {
                            "type": "openNotepad",
                            "payload": "file_sys/my_computer/fun [3]/my room [1]/about this.txt",
                            "title": "about this.txt"
                        }
                    }
                ]
            }
        ...
        "window-fun-3-random-4": {
            "title": "my_computer\\fun\\random",
            "width": 800,
            "height": 600,
            "top": "10%",
            "left": "20%",
            "content": {
                ...
                "payload": [
                    {
                        "id": "plasticity-and-blender-1mp4-ow89u",
                        "name": "plasticity and blender.mp4",
                        "iconType": "videoFile",
                        "description": "",
                        "iconSVG": "",
                        "action": {
                            "type": "openVideo",
                            "payload": "file_sys/my_computer/fun [3]/random [4]/plasticity and blender [1].mp4",
                            "title": "plasticity and blender [1].mp4"
                        }
                    },
                    {
                        "id": "animated-credit-cards-2fig-q8qli",
                        "name": "Animated Credit Cards.fig",
                        "iconType": "figma",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#F24E1E\" d=\"M7.5,16.5A1.5,1.5 0 0,1 6,15V12A1.5,1.5 0 0,1 7.5,10.5H9V12H7.5V15H9V16.5H7.5M12,15A1.5,1.5 0 0,1 10.5,13.5V12A1.5,1.5 0 0,1 12,10.5A1.5,1.5 0 0,1 13.5,12V13.5A1.5,1.5 0 0,1 12,15M12,9A1.5,1.5 0 0,1 10.5,7.5A1.5,1.5 0 0,1 12,6A1.5,1.5 0 0,1 13.5,7.5A1.5,1.5 0 0,1 12,9M16.5,13.5A1.5,1.5 0 0,1 15,12A1.5,1.5 0 0,1 16.5,10.5H18V12H16.5V13.5M16.5,9A1.5,1.5 0 0,1 15,7.5V6H16.5A1.5,1.5 0 0,1 18,7.5V9H16.5Z\" /></svg>",
                        "action": {
                            "type": "openFig",
                            "payload": "file_sys/my_computer/fun [3]/random [4]/Animated Credit Cards [2].fig",
                            "title": "Animated Credit Cards [2].fig",
                            "figContent": "[fig]\ntitle=Animated Credit Cards\nfile=Themed Credit Cards\nimages=[H]DIY Cards\n\ncomment=Sharvesh,This was an experiment we did for the digital credit card HDFC was planning to offer, now called Pixel Credit Card.\ncomment=Sharvesh,Bank did like the approach but it needed more effort and approvals than we were comfortable with at the moment and to print the cards with dedicated themes was something they weren't very keen on for cost reasons.\n\n\n",
                            "figImages": [
                                {
                                    "name": "Aquarium Home",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B1%5DAquarium%20Home%20%5B1%5D.json",
                                    "ext": ".json",
                                    "sortOrder": 1,
                                    "row": 1,
                                    "overlay": {
                                        "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/overlay/%5B1%5D%20overlayBlue%20%5B50-50-0.93%5D%20%5B1%5D.png",
                                        "ext": ".png",
                                        "x": 50,
                                        "y": 50,
                                        "scale": 0.93
                                ...
                                {
                                    "name": "Football Home",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B1%5DFootball%20Home%20%5B2%5D.json",
                                    "ext": ".json",
                                    "sortOrder": 1,
                                    "row": 2
                                },
                                {
                                    "name": "geometric card",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B1%5Dgeometric%20card%20%5B3%5D.mp4",
                                    "ext": ".mp4",
                                    "sortOrder": 1,
                                    "row": 3,
                                    "overlay": {
                                        "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/overlay/%5B1%5D%20overlayBlue%20%5B50-50-0.93%5D%20%5B3%5D%20.png",
                                        "ext": ".png",
                                        "x": 50,
                                        "y": 50,
                                        "scale": 0.93
                                ...
                                {
                                    "name": "Aquarium Deactivated",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B2%5DAquarium%20Deactivated%20%5B1%5D.json",
                                    "ext": ".json",
                                    "sortOrder": 2,
                                    "row": 1
                                },
                                {
                                    "name": "Football Deactivated",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B2%5DFootball%20Deactivated%20%5B2%5D.json",
                                    "ext": ".json",
                                    "sortOrder": 2,
                                    "row": 2
                                },
                                {
                                    "name": "Geometric Dectivated",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B2%5DGeometric%20Dectivated%20%5B3%5D.png",
                                    "ext": ".png",
                                    "sortOrder": 2,
                                    "row": 3
                                },
                                {
                                    "name": "Aquarium Swipe to Pay",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B3%5D%20Aquarium%20Swipe%20to%20Pay%20%5B1%5D.json",
                                    "ext": ".json",
                                    "sortOrder": 3,
                                    "row": 1
                                },
                                {
                                    "name": "Football CC",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B3%5D%20Football%20CC%20%5B2%5D.png",
                                    "ext": ".png",
                                    "sortOrder": 3,
                                    "row": 2
                                },
                                {
                                    "name": "Aquarium Tap n Pay",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B4%5D%5B0x00000000%5D%20Aquarium%20Tap%20n%20Pay%5B1%5D.gif",
                                    "ext": ".gif",
                                    "sortOrder": 4,
                                    "row": 1,
                                    "bgColor": "#00000000"
                                },
                                {
                                    ...
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B5%5D%20Theme%20Selection%20%5B1%5D.png",
                                    "ext": ".png",
                                    "sortOrder": 5,
                                    "row": 1
                                },
                                {
                                    "name": "Aquarium CC",
                                    "path": "file_sys/my_computer/fun%20%5B3%5D/random%20%5B4%5D/%5BH%5DDIY%20Cards/%5B6%5D%20Aquarium%20CC%20%5B1%5D.png",
                                    "ext": ".png",
                                    "sortOrder": 6,
                                    "row": 1
                                }
                            ...
                            "figRowLabels": {
                                "1": "Aquarium Theme\r\nThe Tap and Pay and Swipe to Pay versions were something we proposed to use during those payment modes being used.",
                                "2": "Football Theme\r\nAnimating this one was so much fun. We did these as a POC and all of them are exploratory. These were all lightweight lotties.",
                                "3": "Abstract Geometric Shapes Theme\r\nTo show a direction we could have just for the aesthetics. These would ideally be handed over to a dedicated agency."
                            },
                            "figRowSpacing": {}
                        }
                    },
                    {
                        "id": "3d-for-zapp-carousel-3jpg-zu1pm",
                        "name": "3D for zapp carousel.jpg",
                        "iconType": "imageFile",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#B2EBF2\" d=\"M21.4,6.6l-2.8-2.8C18.3,3.5,17.9,3.3,17.5,3.3H6.5C5.7,3.3,5,4,5,4.8v14.4c0,0.8,0.7,1.5,1.5,1.5h11c0.8,0,1.5-0.7,1.5-1.5V7.5C19,7.1,18.8,6.7,18.6,6.4L21.4,6.6z M13,18H7v-2h6V18z M17,14H7v-2h10V14z M17,10H7V8h10V10z\"/></svg>",
                        "action": {
                            "type": "openImage",
                            "payload": "file_sys/my_computer/fun [3]/random [4]/3D for zapp carousel [3].jpg",
                            "title": "3D for zapp carousel [3].jpg"
                        }
                    }
                ]
            }
        },
        "window-fun-3-the-ae86-wallpaper-3": {
            "title": "my_computer\\fun\\ford mustang wallpaper",
            "width": 800,
            "height": 600,
            "top": "10%",
            "left": "20%",
            "content": {
                ...
                "payload": [
                    {
                        "id": "ae86-wallpaper-s23-1mp4-tcwbe",
                        "name": "Ford Mustang Wallpaper.mp4",
                        "iconType": "videoFile",
                        "description": "",
                        "iconSVG": "",
                        "action": {
                            "type": "openVideo",
                            "payload": "file_sys/my_computer/fun [3]/the ae86 wallpaper [3]/AE86 Wallpaper S23 [1].mp4",
                            "title": "Ford Mustang Wallpaper.mp4"
                        }
                    },
                    {
                        "id": "in-affinity-2png-rq72v",
                        "name": "in affinity.png",
                        "iconType": "imageFile",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#B2EBF2\" d=\"M21.4,6.6l-2.8-2.8C18.3,3.5,17.9,3.3,17.5,3.3H6.5C5.7,3.3,5,4,5,4.8v14.4c0,0.8,0.7,1.5,1.5,1.5h11c0.8,0,1.5-0.7,1.5-1.5V7.5C19,7.1,18.8,6.7,18.6,6.4L21.4,6.6z M13,18H7v-2h6V18z M17,14H7v-2h10V14z M17,10H7V8h10V10z\"/></svg>",
                        "action": {
                            "type": "openImage",
                            "payload": "file_sys/my_computer/fun [3]/the ae86 wallpaper [3]/in affinity [2].png",
                            "title": "in affinity [2].png"
                        }
                    },
                    {
                        "id": "about-this-wallpaper-3txt-zt58l",
                        "name": "about this wallpaper.txt",
                        "iconType": "notepad",
                        "description": "",
                        "iconSVG": "",
                        "action": {
                            "type": "openNotepad",
                            "payload": "file_sys/my_computer/fun [3]/the ae86 wallpaper [3]/about this wallpaper [3].txt",
                            "title": "about this wallpaper [3].txt"
                        }
                    }
                ]
            }
                ...
                "payload": [
                    {
                        ...
                        "action": {
                            "type": "openWindow",
                            "payload": "window-fun-3-my-room-1"
                        }
                    },
                    {
                        "id": "posters-2-pjr0d",
                    ...
                    {
                        "id": "the-ae86-wallpaper-3-bfsbl",
                        "name": "ford mustang wallpaper",
                        "displayName": "ford mustang wallpaper [3]",
                        "iconType": "folder",
                        "description": "",
                        "iconSVG": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#F9E79F\" d=\"M10 4H4c-1.11 0-2 .89-2 2v12c0 1.1.89 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.11-.9-2-2h-8l-2-2z\"/></svg>",
                        "badge": null,
                        ...
                        "action": {
                            "type": "openWindow",
                            "payload": "window-fun-3-the-ae86-wallpaper-3"
                        }
                    },
                    {
                        "id": "random-4-kxdkn",
